        ...
        <div className="space-y-6">
          ...
          <div className="glass-panel rounded-3xl border border-border p-6">
            ...
            <p className="mt-4 rounded-2xl border border-border bg-background/50 p-4 text-xs leading-7 text-muted-foreground">
              پس از واریز مبلغ دقیق، لطفاً رسید پرداخت خود را برای بررسی و
              تأیید دستی ارسال کنید.
            </p>
            ...
            <>
              <div className="rounded-3xl border border-border bg-card/70 p-6">
                ...
                <p className="mb-4 text-xs leading-7 text-muted-foreground">
                  این اطلاعات همراه رسید برای پشتیبانی ارسال می‌شود تا سفارش
                  شما تأیید و تحویل شود.
                </p>
              ...
              <div className="rounded-3xl border border-border bg-card/70 p-6">
                ...
                <p className="mb-4 text-xs leading-7 text-muted-foreground">
                  تصویر رسید را از گالری انتخاب کنید یا همین حالا از رسید
                  عکس بگیرید. فرمت‌های مجاز: JPG، JPEG و PNG.
                </p>
              ...
              <div className="rounded-3xl border border-border bg-card/70 p-6">
                ...
                <p className="mb-4 text-xs leading-7 text-muted-foreground">
                  متن زیر به‌صورت خودکار از روی محصول انتخابی ساخته شده است.
                  با زدن دکمهٔ واتساپ همین متن آمادهٔ ارسال می‌شود و برای
                  تلگرام، متن کپی می‌شود تا در گفت‌وگو بچسبانید. در هر دو
                  حالت، تصویر رسید را هم در همان گفت‌وگو بفرستید.
                </p>
                ...
                {!ready ? (
                  <p className="mt-4 rounded-2xl border border-border bg-background/50 p-4 text-xs leading-7 text-muted-foreground">
                    برای فعال شدن دکمه‌های ارسال، نام و شماره تماس را وارد
                    کنید و تصویر رسید را انتخاب کنید.
                  </p>
                ) : null}
                ...
                <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                  ...
                  <a
                    href={
                      ready ? whatsappUrlWithText(orderMessage) : undefined
                    }
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-disabled={!ready}
                ...
                <p className="mt-4 rounded-2xl border border-border bg-background/50 p-4 text-xs leading-7 text-muted-foreground">
                  ...
                  <span dir="ltr">@{CONTACT_TELEGRAM_ID}</span> باز می‌شود
                  و شما تصویر رسید را همراه همین متن ارسال می‌کنید.
                </p>
                ...
                {submitted ? (
                  ...
                  >
                    رسید شما ثبت شد. پرداخت شما به‌صورت دستی بررسی و تأیید
                    خواهد شد.
                  </p>
                ) : null}
              </div>
