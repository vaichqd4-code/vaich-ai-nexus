...
export const faqItems = [
  ...
  },
  {
    ...
    a: "پرداخت به صورت کارت‌به‌کارت انجام می‌شود. پس از تکمیل فرم سفارش، با لمس دکمه «ارسال رسید در ربات»، تصویر فیش واریزی خود را در ربات تلگرام ارسال می‌کنید تا بلافاصله بررسی و اشتراک شما فعال شود.",
  },
  {
